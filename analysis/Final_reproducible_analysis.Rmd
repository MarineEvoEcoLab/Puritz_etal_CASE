...
> **SP1**); see the `spawn_key2lab` mapping in the setup chunk and Table S6. Conversion to
...
the manuscript. `Table S5` is the full member-gene listing for every cluster, one
